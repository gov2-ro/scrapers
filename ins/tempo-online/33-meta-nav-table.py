...
# Define the path to the directory and output file
data_path = 'data/_obsolete/matrices'
output_csv_path = 'data/matrices.csv'
...
with open(output_csv_path, mode='w', newline='', encoding='utf-8') as csv_file:
    ...
    for filename in os.listdir(data_path):
        if filename.endswith('.json'):
            ...
            # Open and load the JSON file with error handling for encoding issues
            try:
